...
<section class="">
		...
		?>
			...
			<section class="properties">
				<h1 class="properties" style="text-align: center">Find You Dream Cars For Hire</h1>
				<strong><h3 class="properties" style="text-align: center">"Unlock Your Journey"</h3></strong>
			</section>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold">Client Login</h3>
